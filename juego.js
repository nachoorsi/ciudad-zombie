...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 110, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 200, 430, 50, 50, 1),
    new Obstaculo('imagenes/valla_vertical.png', 800, 80, 50, 50, 1),
    new Obstaculo('imagenes/bache.png', 500, 430, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 520, 80, 20, 20, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 800, 500, 50, 30, 1),
    new Obstaculo('imagenes/bache.png', 70, 230, 50, 50, 1)
  ...
  enemigos: [
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 1, rangoMov, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 1, rangoMov, 'v'),
    new ZombieConductor('imagenes/tren_horizontal.png', 200, 322, 90, 30, 1, rangoMov, 'h'),
    new ZombieCaminante('imagenes/zombie1.png', 230, 410, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie2.png', 120, 150, 10, 10, 2, rangoMov),
    new ZombieCaminante('imagenes/zombie3.png', 120, 320, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie1.png', 120, 90, 10, 10, 1, rangoMov),
    new ZombieCaminante('imagenes/zombie2.png', 120, 150, 10, 10, 2, rangoMov),
